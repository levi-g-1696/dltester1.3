    ...
    public partial class init2 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 10, new DateTime(2022, 5, 20, 15, 9, 24, 7, DateTimeKind.Local).AddTicks(2719), new DateTime(2022, 5, 21, 15, 9, 24, 20, DateTimeKind.Local).AddTicks(4010), true, true, "Aa12345", "admin" },
                    { 11, new DateTime(2022, 5, 20, 15, 9, 24, 20, DateTimeKind.Local).AddTicks(5479), new DateTime(2022, 5, 21, 15, 9, 24, 20, DateTimeKind.Local).AddTicks(5500), false, true, "1234", "user1" },
                    { 22, new DateTime(2022, 5, 20, 15, 9, 24, 20, DateTimeKind.Local).AddTicks(5508), new DateTime(2022, 5, 21, 15, 9, 24, 20, DateTimeKind.Local).AddTicks(5513), false, true, "1234", "user2" }
                });
